...
class OutputCheck(unittest.TestCase):
    ...
    def check_nonetype(self, output):
        self.assertTrue(
            output is not None,
            "Output is NoneType. It seems this function has not "
    ...
    def check_ndarray(self, output, ndim=None, shape=None, dtype=None, msg=""):
        ...
        self.assertTrue(
            not empty,
            "At least one dimension of the array is empty.\n"
        ...
        self.assertTrue(
            not is_matrix,
            "Output returned a matrix and not a numpy.array. "
            "Your function returned an object of {}. "
            "{}".format(type(output), msg),
        )
        ...
        if ndim is not None:
            ...
            self.assertTrue(
                is_correct_ndim,
                "Output must be a {}D array. Your function returned an array of {} "
                "dimensions. "
        ...
        if shape is not None:
            ...
            self.assertTrue(
                is_correct_shape,
                "Output must be an array with shape {}. Your function returned "
                "an array with shape {}. "
        ...
        if dtype is not None:
            ...
            self.assertTrue(
                is_correct_dtype,
                "Output must be a numpy.array with dtype '{}'. Your function returned "
                "an array with dtype '{}'. "
    ...
    def check_array_dims(self, output, array_type):
        ...
        if array_type == "2d":
            self.assertTrue(
                len(dims) == 2,
                "Output must be a 2D array. Your function returned an array of {} "
            ...
            self.assertTrue(
                len(dims) == 3,
                "Output must be a 3D array. Your function returned an array of {} "
                "dimensions.".format(len(dims)),
            )
    ...
    def check_tuple(self, output, length):
        ...
        self.assertTrue(
            len(output) == length,
            "Tuple does not have the required number of elements. "
    ...
    def check_list(self, output, length=None):
        ...
        if length is not None:
            self.assertTrue(
                length == len(output),
                "List does not have the required number of elements. "
    ...
    def check_list_or_tuple(self, output, length=None):
        ...
        if length is not None:
            self.assertTrue(
                length == len(output),
                "List or tuple does not have the required number of elements. "
                "Your function returned a {}-element list or tuple while the "
                "answer must be a {}-element list or tuple".format(len(output), length),
            )
